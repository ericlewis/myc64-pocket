...
generate
	if(PARPORT) begin
		iecdrv_mem #(8,15,"core/mister/rtl/iec_drive/c1541_dolphin.mif") rom
		(
			.clock_a(clk_sys),
			.address_a(rom_addr),
			.data_a(rom_data),
		...
		iecdrv_mem #(8,14,"core/mister/rtl/iec_drive/c1541_rom.mif") rom
		(
			.clock_a(clk_sys),
...
wire [7:0] romstd_do;
iecdrv_mem #(8,14,"core/mister/rtl/iec_drive/c1541_rom.mif") romstd
(
	.clock_a(clk_sys),
	.address_a(rom_addr[13:0]),
	.data_a(rom_data),
